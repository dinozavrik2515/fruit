...
public:
	...
	void update()
	{
		...
		sprite.setTextureRect(IntRect(100 * nom, 0, 130, 130));
...
void display()
{
	...
	Image fonimage;
	fonimage.loadFromFile("C:/Users/Маша/source/repos/fruit/images/fon3.jpg");
	...
	Image fruitsimage;
	fruitsimage.loadFromFile("C:/Users/Маша/source/repos/fruit/images/Без названия327_20240913105909.png");

	Texture fruitstexture;
	fruitstexture.loadFromImage(fruitsimage);

	Sprite fruitsprite;
	fruitsprite.setTexture(fruitstexture);

	Fruits fruit[8];
	for (int i = 0; i < 8; i++)
	{
		fruit[i].set(fruitstexture, 110 * i, ground);
		
	}
	int pusk = 100;

	Sprite ArbScore(fruitstexture);
	...
	Image sc;
	sc.loadFromFile("C:/Users/Маша/source/repos/fruit/images/watermelon.png");

	Texture sct;
	sct.loadFromImage(sc);
	Score score(sct);

	Texture cr;
	cr.loadFromFile("images/Red - Cross - Mark - Download - PNG.png");
	Sprite cross[3];
